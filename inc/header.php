        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
          ...
          <?php if (Session::get('id') == TRUE) { ?>
            ...
            ">
              ...
              <a class="nav-link" href="profile.php?id=<?php echo Session::get("id"); ?>"><i class="fab fa-500px mr-2"></i>Update Password <span class="sr-only">(current)</span></a>
            </li>
          ...
          <?php }else{ ?>
              ...
              <?php
                         ...
                         ?>">
                <a class="nav-link" href="register.php"><i class="fas fa-user-plus mr-2"></i>Add Password</a>
              </li>
              <li class="nav-item
                <?php
